...
export class CreateWorkflowTable1768461834085 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "knowledge_base" ALTER COLUMN "embedding_model" DROP NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `UPDATE "knowledge_base" SET "ai_config_id" = NULL WHERE "ai_config_id" IS NOT NULL AND "ai_config_id" NOT IN (SELECT "id" FROM "ai_provider_configs")`,
    );
    await queryRunner.query(
      `UPDATE "knowledge_base" SET "embedding_config_id" = NULL WHERE "embedding_config_id" IS NOT NULL AND "embedding_config_id" NOT IN (SELECT "id" FROM "ai_provider_configs")`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "knowledge_base" ALTER COLUMN "embedding_model" SET NOT NULL`,
    );
