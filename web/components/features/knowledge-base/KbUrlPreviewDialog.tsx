...
import { ExternalLink, Image as ImageIcon, Code, Clock, FileText, RotateCcw, Save, BrainCircuit, ScanEye, X } from 'lucide-react'
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-6xl w-[95vw] h-[90vh] flex flex-col p-0 gap-0 overflow-hidden">
                <DialogHeader className="px-6 py-4 border-b bg-muted/5 flex-row items-center justify-between space-y-0">
                    <DialogTitle className="flex items-start gap-2 w-full">
                    ...
                    <ScrollArea className="h-full">
                        <div className="p-6 space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-muted/5 rounded-xl border border-border/50">
                                    <div>
                            ...
                            <div className="space-y-4">
                                ...
                                <Textarea
                                    ...
                                    readOnly
                                    className="min-h-[60px] bg-muted/5 resize-none leading-relaxed"
                                />
                            </div>
                            ...
                            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                                ...
                                <TabsContent value="content" className="mt-4 space-y-4">
                                    <div className="p-4 bg-muted/10 border-border/50 border rounded-xl max-w-full overflow-x-auto">
                                        ...
                                        {isPreview ? (
                                            <div className="min-h-[400px] p-4 bg-background border rounded-md prose prose-sm max-w-none dark:prose-invert overflow-auto">
                                            ...
                                            <>
                                                <Textarea
                                                    ...
                                                    className="min-h-[400px] font-mono text-xs leading-relaxed bg-background"
                                ...
                                <TabsContent value="image" className="mt-4">
                                    <Card className="overflow-x-auto border-dashed max-w-full">
                                        {document.metadata?.ogImage ? (
                                            ...
                                            <div className="h-[300px] bg-muted/10 flex flex-col items-center justify-center text-muted-foreground gap-3">
                                ...
                                <TabsContent value="schema" className="mt-4">
                                    <Card className="bg-slate-950 text-slate-50 p-4 border-slate-800 max-w-full overflow-x-auto">
                                        <pre className="text-xs font-mono overflow-auto max-h-[400px] w-full">
                                            {JSON.stringify({
                                                id: document.id,
